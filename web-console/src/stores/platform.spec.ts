    ...
    api.listAssetHistory.mockResolvedValue([
      {
        ...
        file_path: 'G:/electric-ai-runtime/outputs/images/12_0_1.png',
        model_name: 'sd15-electric',
        status: 'scored',
      ...
      },
      {
        ...
        file_path: 'G:/electric-ai-runtime/outputs/images/11_0_1.png',
        model_name: 'sd15-electric',
        status: 'scored',
    ...
    inflight.resolve([
      {
        ...
        local_path: 'G:/electric-ai-runtime/models/sd15-electric',
    ...
    api.listAssetHistory.mockResolvedValue([
      {
        ...
        file_path: 'G:/electric-ai-runtime/outputs/images/22_0_1.png',
        model_name: 'sd15-electric',
        status: 'scored',
