...
def expected_figure_inventory() -> list[FigureSpec]:
    ...
    trailing_specs = [
        ...
        FigureSpec("18_yolo_training_loss_curve.png", "YOLO11 辅助检测训练损失曲线", "辅助检测模型训练结果分析", "model/training/scoring/electric-score-v2/yolo11s-image2-1100-m5-v2/results.csv"),
        FigureSpec("19_yolo_lr_curve.png", "YOLO11 辅助检测学习率曲线", "辅助检测模型训练结果分析", "model/training/scoring/electric-score-v2/yolo11s-image2-1100-m5-v2/results.csv"),
        FigureSpec("20_yolo_progress_throughput_curve.png", "YOLO11 辅助检测训练进度与吞吐率图", "辅助检测模型训练结果分析", "model/training/scoring/electric-score-v2/yolo11s-image2-1100-m5-v2/results.csv"),
